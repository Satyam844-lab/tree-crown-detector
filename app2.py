...
- **Undercounts dense, closed canopy.** Adjacent trees are often merged into a single detection.
...
- **Segmentation uses MobileSAM**, a compressed model chosen to fit free-tier hosting memory — mask precision may be lower than full SAM.
